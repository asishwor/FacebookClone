...
const MainContent = () => {
  return (
    <>
      <div className="fixed w-[100vw] py-[30px] mb-[30px] mainContent  flex  max-h-[100vh] pb-[50px]  left-0 right-0 ">
        <div className=" flex-1   sm:max-w-[500px] max-w-[100%] mx-auto flex flex-col gap-2 justify-top  sm:px-[20px]">
          <div className="storySlider bg-[var(--white-color)] rounded-2xl w-[100%]  px-0 py-[30px] mb-24">
