...
const MainContent = () => {
  return (
    <>
      <div className="mainContent flex-1 py-[30px]  sm:max-w-[600px] max-w-[100%] mx-auto flex flex-col gap-2 justify-top max-h-[100vh] overflow-y-auto   sm:px-[20px]">
        <div className="storySlider bg-[var(--white-color)] rounded-2xl w-[100%]  px-0 py-[3px]">
      ...
      <Post name={"Mamata Dhakal Khadka"} postImage={'/Images/profile2.jpg'}  post={"When Life Gets Blurry, Adjust Your FOCUS❣️"}  image={'/Images/profile3.jpg'}/>

      <Post name={"Sangam Khadka"} postImage={'/Images/profile3.jpg'}  post={"When Life Gets Blurry, Adjust Your FOCUS❣️"}  image={'/Images/story1.jpg'}/>
